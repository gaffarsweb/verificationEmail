// Wild Bounty — underworld / boxing arena theme (matches Jili original)
export const WB_SYMBOLS = {
...
export const getSymbol = (id) =>
  WB_SYMBOLS[id] || { name: '?', label: 'Empty', color: '#333', emoji: '?', tier: 'unknown' };

export const WB_BET_SIZES = [0.01, 0.02, 0.03, 0.05, 0.1, 0.2, 0.5, 1];
export const WB_BET_LEVELS = [1, 2, 3, 5, 10, 20, 50];

// Wild Bounty Enhancement R1 — Tiered Bonus Buy (GDD §4.2)
// 3 SKUs: Small (40×), Standard (100×, certified unchanged), Max (250×)
export const WB_BONUS_BUY_OPTIONS = [
  {
...
export const WB_VARIANT_OPTIONS = [
  {
    id: 'RISKY',
    name: 'Risky',
    icon: '⚔️',
...
export const WB_REEL_ROWS = [3, 4, 5, 5, 4, 3];
export const WB_MAX_ROWS = 5;
...
export const WB_MULT_TIERS = [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024];
